        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodGP = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_Provider_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecords_AspNetUsers_Patient_id",
                        column: x => x.Patient_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Medication_id = table.Column<int>(type: "int", nullable: true),
                    MedicalRecord_id = table.Column<int>(type: "int", nullable: true),
                    Dosage = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Record_Medications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Record_Medications_MedicalRecords_MedicalRecord_id",
                        column: x => x.MedicalRecord_id,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Record_Medications_Medications_Medication_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Record_Medications_MedicalRecord_id",
                table: "Record_Medications",
                column: "MedicalRecord_id");

            migrationBuilder.CreateIndex(
                name: "IX_Record_Medications_Medication_id",
                table: "Record_Medications",
